        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Admin = table.Column<string>(type: "nvarchar(2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ExpDate = table.Column<string>(type: "nvarchar (5)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TransactionId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CoinName = table.Column<string>(type: "nvarchar (20)", nullable: true),
                    Amount = table.Column<decimal>(type: "decimal (10,4)", nullable: false),
                    BuyOrSell = table.Column<string>(type: "nvarchar (8)", nullable: true),
                    CryptoAdress = table.Column<string>(type: "nvarchar (100)", nullable: true),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
